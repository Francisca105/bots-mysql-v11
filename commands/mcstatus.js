...
module.exports.run = async (client, message, args) => {
    ...
    .then(function (response) {
        ...
        .setTitle('<a:tnt_2:630101901081575424> ▫️ Informações do servidor')
        .setDescription('Nesse momento o servidor se encontra off-line.\n<a:engrenagim:689569455898099809> **Status do servidor:** <:desativado:609718365069770762> \n**IP:** ' + ip)
